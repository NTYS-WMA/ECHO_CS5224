"""
Tests for the Proactive Engagement Service v2.0.
...
class TestDomainModels:
    ...
    def test_task_status_values(self):
        from proactive_engagement_service.models.domain import TaskStatus
    ...
    def test_task_type_values(self):
        from proactive_engagement_service.models.domain import TaskType

        assert TaskType.ONE_TIME == "one_time"
        assert TaskType.RECURRING == "recurring"

    def test_schedule_config_one_time(self):
        from proactive_engagement_service.models.domain import ScheduleConfig
    ...
    def test_task_payload_text(self):
        from proactive_engagement_service.models.domain import TaskPayload
    ...
    def test_scheduled_task_creation(self):
        from proactive_engagement_service.models.domain import (
            ScheduleConfig,
            ScheduledTask,
            TaskPayload,
            TaskStatus,
...
class TestUtilities:
    ...
    def test_generate_task_id(self):
        from proactive_engagement_service.utils.helpers import generate_task_id
    ...
    def test_generate_event_id(self):
        from proactive_engagement_service.utils.helpers import generate_event_id

        eid = generate_event_id()
        assert eid.startswith("evt_")

    def test_generate_poll_id(self):
        from proactive_engagement_service.utils.helpers import generate_poll_id
    ...
    def test_utc_now(self):
        from proactive_engagement_service.utils.helpers import utc_now

        now = utc_now()
        assert now.tzinfo is not None

    def test_compute_next_run_at_scheduled(self):
        from proactive_engagement_service.utils.helpers import compute_next_run_at
...
class TestRequestModels:
    ...
    def test_register_task_request_valid(self):
        from proactive_engagement_service.models.requests import RegisterTaskRequest
        from proactive_engagement_service.models.domain import (
            ScheduleConfig,
            TaskPayload,
            TaskType,
    ...
    def test_update_task_request_partial(self):
        from proactive_engagement_service.models.requests import UpdateTaskRequest
        from proactive_engagement_service.models.domain import TaskPayload
    ...
    def test_manual_poll_trigger_defaults(self):
        from proactive_engagement_service.models.requests import ManualPollTriggerRequest
...
class TestResponseModels:
    ...
    def test_task_response_from_domain(self):
        ...
        from proactive_engagement_service.models.responses import TaskResponse
    ...
    def test_poll_cycle_response(self):
        from proactive_engagement_service.models.responses import (
            PollCycleResponse,
            PollExecutionResult,
        )
    ...
    def test_task_deleted_response(self):
        from proactive_engagement_service.models.responses import TaskDeletedResponse
...
class TestEventModels:
    ...
    def test_task_dispatched_event(self):
        from proactive_engagement_service.models.events import TaskDispatchedEvent
    ...
    def test_task_failed_event(self):
        from proactive_engagement_service.models.events import TaskFailedEvent
    ...
    def test_outbound_message_payload(self):
        from proactive_engagement_service.models.events import OutboundMessagePayload
...
class TestHealthRoutes:
    ...
    def setup_method(self):
        ...
        from proactive_engagement_service.routes.health_routes import router
...
class TestTaskRouteValidation:
    ...
    def setup_method(self):
        ...
        from fastapi import FastAPI
        from proactive_engagement_service.routes.task_routes import router, get_task_service
        from proactive_engagement_service.services.task_service import TaskService
        from proactive_engagement_service.services.db_client import DatabaseServiceClient

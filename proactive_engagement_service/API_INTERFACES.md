# Proactive Engagement Service — API Interface Reference v2.0

> This document defines all HTTP APIs exposed by the Proactive Engagement Service.
...
The Proactive Engagement Service v2.0 is a **scheduled task management and polling engine** for proactive outbound messaging in the ECHO platform. It provides:
...
```json
{ "status": "healthy", "service": "proactive-engagement-service" }
```

### 5.2 Readiness — `GET /ready`

```json
{ "status": "ready", "service": "proactive-engagement-service" }
```

...
try:
    import sys
    perf_monitoring_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'performance_monitoring')
...
class Memory(MemoryBase):
    ...
    def search(
        ...
        *,
        ...
        """
        # Performance monitoring - start total timing
